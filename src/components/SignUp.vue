      ...
      <v-main>
        ...
        <v-form @submit.prevent="registerUser">
          ...
          <div v-if="!isPasswordMatching">
            <p>
              비밀번호와 비밀번호 확인이 일치하지 않습니다. 다시 확인하세요.
            </p>
          </div>
          ...
          <v-row justify="center" class="pa-0">
            ...
            <v-col cols="2">
              <input
                ...
                readonly
              />
              <button type="button" id="postcode" @click="openPostcode">
                검색</button
              ><br />
              <input
                type="text"
          ...
          <v-btn variant="tonal" type="submit"> 가입하기 </v-btn>
        </v-form>
      </v-main>
  ...
  methods: {
    async checkDuplicateId() {
      try {
        ...
        axios
          .get("http://13.125.225.44:9999/user/duplicate", {
            params: {
              memberId: memberId,
            },
          })
    ...
    registerUser() {
      ...
      var url = "http://13.125.225.44:9999/user";
