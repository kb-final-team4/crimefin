      ...
      <!-- 추가 메뉴 아이템 작성 -->
        ...
        <div class="black-bg4" v-if="modal4==true">
            <div class="white-bg4">
                ...
                <v-col cols="8" >
                <v-text-field label="현재 비밀번호" id="password" v-model="password" required outlined class="t-field"></v-text-field>
                </v-col>

                <v-col cols="8" >
                <v-text-field label="새로운 비밀번호" id="newPassword" v-model="newPassword" required outlined class="t-field"></v-text-field>
                </v-col>

                <v-col cols="8" >
                <v-text-field label="비밀번호 확인" id="passwordConfirm" v-model="passwordConfirm" required outlined class="t-field"></v-text-field>
                </v-col>
