        ...
        <v-sheet id="questMainSheet">
          ...
          <v-row id="selectRole" v-if="isSelectRole === true">
            <v-sheet class="mx-auto" width="800">
              ...
              <v-row>
                <v-col :cols="4"></v-col>
                <v-col :cols="2"><v-img class="gamebtn mx-auto" @click="showQuest('worker')" src="../assets/exp/msgGame/student_btn.png" /></v-col>
                <v-col :cols="2"><v-img class="gamebtn mx-auto" @click="showQuest('worker')" src="../assets/exp/msgGame/worker_btn.png" /></v-col>
                <v-col :cols="4"></v-col>
              </v-row>
              <v-row>
                <v-col :cols="4"></v-col>
                <v-col :cols="2"><v-img class="gamebtn mx-auto" @click="showQuest('parents')" src="../assets/exp/msgGame/parents_btn.png"/></v-col>
                <v-col :cols="2"><v-img class="gamebtn mx-auto" @click="showQuest('elderly')" src="../assets/exp/msgGame/elderly_btn.png" /></v-col>
                <v-col :cols="4"></v-col>
              </v-row>
            </v-sheet>
          </v-row>
          ...
          <v-row class="playGame" v-if="isPlaying === true && isWorkerGame === true">
            ...
            <v-col :cols ="5">
              ...
              <v-sheet class="questArea">
                <v-row v-if="score===0">
                  <v-img class="questPhone mx-auto" src="../assets/exp/msgGame/quest1.png" />
                </v-row>
                <v-row v-if="score===1">
                  <v-img class="questPhone mx-auto" src="../assets/exp/msgGame/quest2.png"/>
                </v-row>
                <v-row v-if="score ===2 ">
                  <v-img class="questPhone mx-auto" src="../assets/exp/msgGame/quest3.png"/>
                </v-row>
              </v-sheet>
            </v-col>
            <v-col :cols="7" class="d-flex justify-center align-center">
              <v-sheet class="answerArea">
                ...
                <v-row class="goodAnswer justify-center">
                  ...
                  <v-img class="answerbtn" v-if="score===1" @click="questReply(1)" src="../assets/exp/msgGame/upper2.png"></v-img>
                  <v-img class="answerbtn" v-if="score===2" @click="questReply(0)" src="../assets/exp/msgGame/upper3.png"></v-img>
                </v-row>
                <v-row class="badAnswer justify-center" >
                  <v-img class="answerbtn" v-if="score===0" @click="questReply(1)" src="../assets/exp/msgGame/lower1.png"></v-img>
