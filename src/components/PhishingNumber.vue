<template>
  <v-app>
    ...
    <v-main class="d-flex align-center justify-center">
      <br /><br />
      <p class="title1">
        저장되지 않은 번호로부터 이체, 금융 정보 요구 등 이상한 연락을 받았나요?
        <br />번호를 조회해 보세요
      </p>
      <br /><br />
      <v-card class="mx-auto my-auto" id="form-container">
        <v-row justify="center">
          <v-col cols="12">
            ...
            <br />
            <p class="subtitle">
              검찰, 경찰, 금융감독원 등의 정부기관은 어떠한 경우에도 전화 또는
              문자로 자금 이체를 요청하거나,<br />
              개인의 통장번호나 공인인증서, 애플리케이션 설치 등을 요구하지
              않습니다
            </p>
          </v-col>
        </v-row>
...
export default {
  ...
  methods: {
    sendPhoneNumber() {
      ...
      axios
        .get("http://13.125.225.44:9999/phishing", { params: { phoneNum } })
        .then((response) => {
